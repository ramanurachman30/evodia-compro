      ...
      <div className="container">
        <div className="grid grid-cols-2 items-center">
            ...
            <div className="pb-24 pl-12" data-aos="fade-up">
                ...
                <Link to="/about-more" className="text-base font-semibold text-white bg-[#3789E5] py-2 px-8 rounded-lg   hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out"
