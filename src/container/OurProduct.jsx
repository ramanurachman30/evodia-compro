...
const Product = () => {
  ...
  return (
    <div className="px-20 py-20 bg-zinc-50">
        <p className='text-4xl pb-10 font-bold text-[#3789E5] text-center' data-aos="fade-down" data-aos-duration="1000">Our Product</p>
        <div className="grid grid-rows-2 gap-6 text-center">
            <div className="grid grid-cols-3 gap-6">
                <div className="bg-[#EEEEEE] grid grid-rows-3 place-content-center gap-2 px-10 py-5 rounded-xl" data-aos="fade-down">
